...
export class PermissionMatrixService {
  private readonly permissions: PermissionMatrix = {
    BORDEREAUX: {
      ...
      READ: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR', 'GESTIONNAIRE', 'BO', 'SCAN'],
      UPDATE: ['SUPER_ADMIN', 'ADMIN', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR', 'GESTIONNAIRE'],
      DELETE: ['SUPER_ADMIN', 'ADMIN'],
      ASSIGN: ['SUPER_ADMIN', 'ADMIN', 'CHEF_EQUIPE'],
      EXPORT: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR']
    },
    CLIENTS: {
      CREATE: ['SUPER_ADMIN', 'ADMIN'],
      READ: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR', 'GESTIONNAIRE'],
      UPDATE: ['SUPER_ADMIN', 'ADMIN'],
      DELETE: ['SUPER_ADMIN'],
      MANAGE_SLA: ['SUPER_ADMIN', 'ADMIN']
    },
    FINANCE: {
      CREATE_OV: ['SUPER_ADMIN', 'ADMIN', 'FINANCE', 'COMPTABILITE'],
      READ_OV: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'FINANCE', 'COMPTABILITE', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR'],
      VALIDATE_OV: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT'],
      UPDATE_OV_STATUS: ['SUPER_ADMIN', 'ADMIN', 'FINANCE', 'COMPTABILITE'],
      EXPORT_OV: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'FINANCE', 'COMPTABILITE']
    },
    WORKFLOW: {
    ...
    GED: {
      ...
      UPDATE: ['SUPER_ADMIN', 'ADMIN', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR'],
      DELETE: ['SUPER_ADMIN', 'ADMIN'],
      EXPORT: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR']
    },
    GEC: {
      READ: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR', 'GESTIONNAIRE'],
      CREATE: ['SUPER_ADMIN', 'ADMIN', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR', 'GESTIONNAIRE'],
      UPDATE: ['SUPER_ADMIN', 'ADMIN', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR'],
      DELETE: ['SUPER_ADMIN', 'ADMIN'],
      EXPORT: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR']
    },
    RECLAMATIONS: {
      READ: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR', 'GESTIONNAIRE', 'CLIENT_SERVICE'],
      CREATE: ['SUPER_ADMIN', 'ADMIN', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR', 'GESTIONNAIRE', 'CLIENT_SERVICE'],
      UPDATE: ['SUPER_ADMIN', 'ADMIN', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR', 'GESTIONNAIRE'],
    ...
    ANALYTICS: {
      READ: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR'],
      EXPORT: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR']
    },
    CONTRACTS: {
      READ: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR'],
    ...
    DASHBOARD: {
      ...
      VIEW_TEAM: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR'],
      VIEW_PERSONAL: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR', 'GESTIONNAIRE', 'FINANCE', 'COMPTABILITE', 'BO', 'SCAN']
    }
  };
