...
export class PermissionMatrixService {
  private readonly permissions: PermissionMatrix = {
    ...
    FINANCE: {
      ...
      READ_OV: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'FINANCE', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR'],
    ...
    DASHBOARD: {
      ...
      VIEW_PERSONAL: ['SUPER_ADMIN', 'ADMIN', 'RESPONSABLE_DEPARTEMENT', 'CHEF_EQUIPE', 'GESTIONNAIRE_SENIOR', 'GESTIONNAIRE', 'FINANCE', 'BO', 'SCAN']
    }
  };
